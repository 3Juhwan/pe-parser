...
int read_nt_header() {
    read_file((BYTE*)&nt_header64.Signature, 4);
...
int read_file_header() {
    read_file((BYTE*)&nt_header64.FileHeader.Machine, 2);
    read_file((BYTE*)&nt_header64.FileHeader.NumberOfSections, 2);
    fseek(fp, 0x0C, SEEK_CUR);
    read_file((BYTE*)&nt_header64.FileHeader.SizeOfOptionalHeader, 2);
    read_file((BYTE*)&nt_header64.FileHeader.Characteristics, 2);
}
...
int read_optional_header() {
    read_file((BYTE*)&nt_header64.OptionalHeader.Magic, 2);
    fseek(fp, 0x0E, SEEK_CUR);
    read_file((BYTE*)&nt_header64.OptionalHeader.AddressOfEntryPoint, 4);
    fseek(fp, 0x04, SEEK_CUR);
    read_file((BYTE*)&nt_header64.OptionalHeader.ImageBase, 8);
    read_file((BYTE*)&nt_header64.OptionalHeader.SectionAlignment, 4);
    read_file((BYTE*)&nt_header64.OptionalHeader.FileAlignment, 4);
    fseek(fp, 0x10, SEEK_CUR);
    read_file((BYTE*)&nt_header64.OptionalHeader.SizeOfImage, 4);
    read_file((BYTE*)&nt_header64.OptionalHeader.SizeOfHeaders, 4);
    fseek(fp, 0x2C, SEEK_CUR);
    read_file((BYTE*)&nt_header64.OptionalHeader.NumberOfRvaAndSizes, 4);
}
